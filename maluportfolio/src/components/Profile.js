...
const Header = () => {
  return (
    <div className='flex flex-col gap-4 ml-20 md:ml-56 pr-10 md:pr-8'>
      ...
      <a className='text-sm md:text-base bg-black max-w-[130px] text-white-100 flex justify-center gap-2 rounded-lg py-2 md:py-4' href="https://linkedin.com/in/marialuisacampos">Resume <HiDownload className='self-center' /></a>
    </ div>
  )
}
